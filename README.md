...
View the running [website](https://codebelt.github.io/react-redux-architecture). Prefer JavaScript check out this [branch](https://github.com/codeBelt/react-redux-architecture/tree/JavaScript)
