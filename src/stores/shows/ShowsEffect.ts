...
export async function requestShow(showId: string): Promise<ShowModel | HttpErrorResponseModel> {
...
export async function requestEpisodes(showId: string): Promise<EpisodeModel[] | HttpErrorResponseModel> {
...
export async function requestCast(showId: string): Promise<CastModel[] | HttpErrorResponseModel> {
 ...
 */
export async function requestError(): Promise<any | HttpErrorResponseModel> {
